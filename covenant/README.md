...
python3 /Users/hd/openclaw/tools/covenant/prepare_spawn.py /path/to/handshake-without-agent.json --auto-route --output-dir /tmp/covenant-spawn
```
...
```bash
python3 /Users/hd/openclaw/tools/covenant/validate_agent_protocol.py --type status /path/to/status.json
python3 /Users/hd/openclaw/tools/covenant/validate_agent_protocol.py --type completion /path/to/completion.json
