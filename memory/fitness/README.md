...
## Catalog Builders
- `npx tsx tools/fitness/refresh-current-tonal-catalog.ts` - Refresh the observed Tonal history snapshot directly from `http://localhost:3033/tonal/data` (ex. `memory/fitness/programs/json/current-tonal-catalog.json`)
