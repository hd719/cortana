...
- Run once daily (typically evening):
  - `python3 /Users/hd/Developer/cortana/tools/reflection/reflect.py --mode sweep --trigger-source heartbeat --window-days 30`
...
### Full sweep
```bash
python3 /Users/hd/Developer/cortana/tools/reflection/reflect.py \
  --mode sweep \
