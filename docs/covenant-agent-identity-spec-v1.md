...
```json
{
  ...
  "constraints": {
    "workspace_root": "/Users/hd/Developer/cortana",
    "allowed_paths": ["/Users/hd/Developer/cortana"],
...
```json
{
  ...
  "artifacts": [
    {"type": "file", "path": "/Users/hd/Developer/cortana/src/health/retry.ts"},
    {"type": "file", "path": "/Users/hd/Developer/cortana/tests/health/retry.test.ts"},
...
## Read/Write Rules
- **All agents can read:** workspace files required for objective (`/Users/hd/Developer/cortana` scope).
- **Agents write only:**
...
- **Agent-local notes (ephemeral):**
  - path: `/Users/hd/Developer/cortana/.covenant/agents/<agent-id>/scratch/`
...
- `/Users/hd/Developer/cortana/agents/identities/monitor.md`
- `/Users/hd/Developer/cortana/agents/identities/huragok.md`
- `/Users/hd/Developer/cortana/agents/identities/oracle.md`
- `/Users/hd/Developer/cortana/agents/identities/librarian.md`
- `/Users/hd/Developer/cortana/agents/identities/schema.json` (handshake + status/completion JSON schemas)

Optional shared contract:
- `/Users/hd/Developer/cortana/agents/identities/CONTRACT.md` (global rules/boundaries)
