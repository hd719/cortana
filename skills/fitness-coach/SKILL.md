...
Output: ~/clawd/memory/fitness/analysis/sleep-recovery-correlation.md
```
...
Output: ~/clawd/memory/fitness/analysis/strength-progression.md
```
...
Output: ~/clawd/memory/fitness/analysis/optimal-strain.md
```
...
Output: ~/clawd/memory/fitness/analysis/hrv-trends.md
```
...
- Weekly summaries: `~/clawd/memory/fitness/weekly/`
