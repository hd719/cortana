...
export function computeAndStoreScorecard(windowDays = 7, dryRun = false) {
  ...
  const metrics = {
    ...
    followup_resolution_rate: clamp(counts.followups_total === 0 ? 100 : (counts.followups_resolved / counts.followups_total) * 100),
