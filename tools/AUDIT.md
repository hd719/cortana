...
Validated each `remove` candidate with full-repo grep (excluding `.git`, virtualenvs, and `node_modules`) and checked cron/heartbeat references before deletion.

Removed as unused/redundant:
- `tools/guardrails/approval-gate.sh` (redundant wrapper around `approval-gate.py`)
- `tools/morning-brief/enrich.sh` (unreferenced)
- `tools/task-board/dedup-check.sh` (unreferenced)
- `tools/task-board/task-board.sh` (unreferenced)
- `tools/trade-alerts/alert.sh` (unreferenced)

No removals impacted `cron/jobs.json`, `HEARTBEAT.md`, or active script dependencies.
...
| `tools/guardrails/approval-gate.sh` | yes | none found | removed (2026-02-26) |
...
| `tools/morning-brief/enrich.sh` | yes | none found | removed (2026-02-26) |
...
| `tools/task-board/dedup-check.sh` | yes | none found | removed (2026-02-26) |
...
| `tools/task-board/task-board.sh` | yes | none found | removed (2026-02-26) |
...
| `tools/trade-alerts/alert.sh` | yes | none found | removed (2026-02-26) |
