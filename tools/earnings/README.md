...
```bash
~/clawd/tools/earnings/check-earnings.sh
~/clawd/tools/earnings/create-calendar-events.sh
# or pipe explicit JSON
~/clawd/tools/earnings/check-earnings.sh | ~/clawd/tools/earnings/create-calendar-events.sh
```
