...
- Optimize sleep (target: consistent REM improvement)
- Track via Whoop + Tonal integration

## 🎓 Master's Program
- Complete EM-605 and remaining coursework
- Stay on top of assignments (HW 597 pending)

## 💼 Career
- Excel at Resilience Cyber
- Build side projects (health metrics product)
- Stay current on AI/security developments

## 💰 Finance
- Monitor and grow stock portfolio
- Track mortgage/housing market for opportunities
- TSLA + NVDA = forever holds

## 🏠 Personal
- TCI trip (Mar 25-29)
- Maintain home infrastructure (TrueNAS, network)
